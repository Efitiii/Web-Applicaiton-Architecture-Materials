...
<div id="global">
<form:form commandName="employee" action="employee_save" enctype="multipart/form-data" >
    <fieldset>
        ...
        <p>
      <spring:message code="emp.addform.firstName"></spring:message>
    ...
    <h4>Address:</h4>
        ...
        <p>
            ...
            <form:input path="empImage" id="empImage" type="file" />
 
 		  	<div style="text-align: center;">
 				<form:errors path="empImage" cssStyle="color : red; " />
 			</div>
       </p>
